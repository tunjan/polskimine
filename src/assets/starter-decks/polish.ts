...
export const POLISH_BEGINNER_DECK: Card[] = [
  ...
  createCard(
    ...
    "I don't have time.",
    "czasu",
    "Genitive case of 'czas' (negation).",
    "time",
    "noun",
  ),
  createCard(
