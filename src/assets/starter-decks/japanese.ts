...
export const JAPANESE_BEGINNER_DECK: Card[] = [
  ...
  createCard(
    ...
    "蒸し暑い",
    "",
    "日本[にほん]の 夏[なつ]は 蒸[む]し 暑[あつ]いです。",
  ),
  createCard(
    "それは面白そうですね。",
