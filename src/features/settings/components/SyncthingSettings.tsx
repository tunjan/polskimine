      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div className="w-12 h-12 bg-card flex items-center justify-center rounded-full border border-border/30 group-hover:border-primary/40 transition-colors">
            <Save
              className={`w-5 h-5 text-muted-foreground/60 group-hover:text-primary/70 transition-colors ${isSaving ? "animate-pulse" : ""}`}
              strokeWidth={1.5}
            />
          </div>
          <div>
        ...
        >
          <div className="w-12 h-12 bg-card flex items-center justify-center rounded-full border border-border/30 group-hover:border-primary/40 transition-colors">
            <Download
              className={`w-5 h-5 text-muted-foreground/60 group-hover:text-primary/70 transition-colors ${isLoading ? "animate-spin" : ""}`}
              strokeWidth={1.5}
            />
          </div>
          <div>
