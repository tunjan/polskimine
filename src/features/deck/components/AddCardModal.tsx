  ...
  const HighlightedPreview = useMemo(() => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-3xl p-0 bg-card border border-border gap-0 overflow-hidden">
                {/* Corner accents */}
                ...
                <form onSubmit={handleSubmit} className="flex flex-col h-full">
                    ...
                    <div className="px-10 pt-12 pb-8 bg-muted/5 relative border-b border-border/30">
                        ...
                        <div className="relative">
                            <textarea
                                ...
                                className="w-full text-3xl md:text-4xl font-light bg-transparent border-none outline-none placeholder:text-muted-foreground/20 resize-none overflow-hidden p-0 leading-tight tracking-tight text-foreground min-h-[120px]"
                                value={form.sentence}
                    ...
                    <div className="px-10 py-10 space-y-10 bg-card">
